...
//transaction.batch([queries]);  if such "author": [
//         {
//             "isFulfilled": true,
//             "isRejected": false,
//             "fulfillmentValue": {
//             "nickname": "hae.nxm2Tl5dwv7UjU",
//                 "fullname": "David White",
//                 "about": "Vos ob sua amemur rei diversitate inest amo me. Incognitam urunt hic. Beatos dum te vituperetur, voluit mei seu nam. Vivit rem res. Vasis ad.",
//                 "email": "hinc.2T6ntkF1wUjU7@tuiistarum.net"
//         }
//         }
    ...
    if (checker.forum !== -1) {
     ...
     //if such ctx.body = [response];
     //  [
     //      {
     //          "post": {
     //              "id": 191,
     //              "author": "sanum.ULnPc5Q1WVjDrV",
     //              "created": "2018-01-06T18:36:35.154Z",
     //              "forum": "-I0RJcTVQerVrv",
     //              "isEdited": false,
     //              "message": "Oris hae supervacuanea pane isti. Quattuor voluerit sparsa quam num quantulum perierat escam tamen vis at ad violis meruit.",
     //              "thread": 135,
     //              "parent": 0
     //          }
     //      }
