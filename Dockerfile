...
RUN echo "autovacuum_vacuum_threshold = 1800" >> /etc/postgresql/$PGVER/main/postgresql.conf
RUN echo "autovacuum_vacuum_scale_factor = 0.1" >> /etc/postgresql/$PGVER/main/postgresql.conf
RUN echo "autovacuum_analyze_threshold = 900" >> /etc/postgresql/$PGVER/main/postgresql.conf
